...
<form name="form1" method="post" action="" style="width:1200px">
    ...
    <fieldset>
		 	<legend>Investiga&ccedil;&atilde;o e An&aacute;lise de Acidente / Incidente / Desvios</legend>
    ...
    <table width="1150" border="1" frame="box" rules="none">
    	<tr>
        	...
        	<td width="535"><input type="checkbox" name="com_afastamento" id="com_afastamento" <?PHP if ($com_afastamento == 's') print 'checked'; ?> />
       	    ...
       	    <input name="tempo_prev_afastamento" type="text" id="tempo_prev_afastamento" value="<?php print $tempo_prev_afastamento ?>" size="28" maxlength="50" />
<label for="tempo_prev_afastamento"></label>
    	...
    	<tr>
    	  ...
    	  <td colspan="4"><font size="-1">
    	    <textarea name="observ_lesao" id="observ_lesao" cols="140" rows="3" value="" onkeyup='charLimit(this, 3000);'><?php print utf8_encode($observ_lesao) ?></textarea>
    	  </font></td>
  	  </tr>
    	<tr>
    	  <td>&nbsp;</td>
    ...
    <table width="871" border="0">
    	<tr>
          ...
          <input name="numero_cat" type="text" id="numero_cat" value="<?php print $numero_cat ?>" size="30" maxlength="50" /></td>
      </tr>
    </table>   
    ...
    <table width="1146" border="0">
    	...
    	<tr>
    	  <td><font size="-1">
    	    <textarea name="cronologia" id="cronologia" cols="145" rows="5" value="" onkeyup='charLimit(this, 3000);'><?php print utf8_encode($cronologia) ?></textarea>
    	  </font></td>
  	  </tr>
    </table>   
    ...
    <table width="1146" border="0">
    	...
    	<tr>
    	  <td><font size="-1">
    	    <textarea name="informacao_acao_chefia" id="informacao_acao_chefia" cols="145" rows="5" value="" onkeyup='charLimit(this, 3000);'><?php print utf8_encode($informacao_acao_chefia) ?></textarea>
    	  </font></td>
  	  </tr>
    </table>                            
    ...
    <table width="1159" border="0">
    	<tr>
        	<td><font size="-1">Total de horas desde o in&iacute;cio do expediente /  jornada at&eacute; a hora do acidente: </font>
        	  <input align="center" name="desc_jornada_trabalho" type="text" id="desc_jornada_trabalho" size="1" maxlength="5"  onkeypress="valida_horas(this)" value="<?php print $desc_jornada_trabalho ?>" onblur="javascript:mascara_hora(this)" />
        	</td>
      </tr>
    </table>  
    ...
    <table width="1143" border="0">
    	<tr>
        	<td><font size="-1">
        	  <textarea name="desc_maquina_ferramental" id="desc_maquina_ferramental" cols="145" rows="5" value="" onkeyup='charLimit(this, 3000);'><?php print utf8_encode($desc_maquina_ferramental) ?></textarea>
        	</font></td>
      </tr>
    </table>  
    ...
    <table width="1156" border="0">
    	<tr>
          ...
          <input name="desc_dificuldade_trabalho" type="text" id="desc_dificuldade_trabalho" value="<?php print utf8_encode($desc_dificuldade_trabalho) ?>" size="70" maxlength="500" align="center"/>
          </font></td>
   	  </tr>
    	<tr>
          ...
          <input name="desc_orientacao_chefia" type="text" id="desc_orientacao_chefia" value="<?php print utf8_encode($desc_orientacao_chefia) ?>" size="70" maxlength="500" align="center"/>
          </font></font></td>
   	  </tr>
    	<tr>
          ...
          <font size="-1">N&atilde;o &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">Obs:
          <input name="desc_outras_pessoas_local" type="text" id="desc_outras_pessoas_local" value="<?php print utf8_encode($desc_outras_pessoas_local) ?>" size="55" maxlength="500" align="center"/>
          </font></font></td>
   	  </tr>
    	<tr>
          ...
          <font size="-1">N&atilde;o &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">Obs:
          <input name="desc_comunic_superior" type="text" id="desc_comunic_superior" value="<?php print utf8_encode($desc_comunic_superior) ?>" size="55" maxlength="500" align="center"/>
          </font></font></td>
   	  </tr>
    	<tr>
          ...
          <input name="desc_dia_evento" type="text" id="desc_dia_evento" value="<?php print utf8_encode($desc_dia_evento) ?>" size="70" maxlength="500" align="center"/>
          </font></font></td>
   	  </tr>
    	<tr>
          ...
          <font size="-1">N&atilde;o&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">Obs:
          <input name="desc_remedio_continuo" type="text" id="desc_remedio_continuo" value="<?php print utf8_encode($desc_remedio_continuo) ?>" size="70" maxlength="500" align="center"/>
          </font></font></td>
   	  </tr>
    	<tr>
          ...
          <input name="desc_usando_epi" type="text" id="desc_usando_epi" value="<?php print utf8_encode($desc_usando_epi) ?>" size="70" maxlength="500" align="center"/>
          </font></font>&nbsp; &nbsp;</td>
   	  </tr>
    	<tr>
    	  <td height="30"><p><font size="-1"><b>Voc&ecirc; tinha conhecimento do risco que estava exposto?&nbsp;(Checar informa&ccedil;&atilde;o  PPRA/OS/F.77)</b>          &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table width="1152" border="1" frame="box" rules="none">
    	...
    	<tr>
          ...
          <font size="-1">N&atilde;o</font><font size="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">Obs:
          <input name="desc_apresentado_bo" type="text" id="desc_apresentado_bo" value="<?php print utf8_encode($desc_apresentado_bo) ?>" size="70" maxlength="500" align="center"/>
          </font></font>&nbsp; &nbsp;&nbsp; </td>
  	  </tr>
    	<tr>
            <td>&nbsp;</td>        
...
<b>O trajeto do fato condiz com a rota  empresa/resid&ecirc;ncia, conforme comprovante de endere&ccedil;o no prontu&aacute;rio? </b>
    	...
    	<tr>
          ...
          <font size="-1">N&atilde;o&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">Obs:
          <input name="desc_horario_jornada" type="text" id="desc_horario_jornada" value="<?php print utf8_encode($desc_horario_jornada) ?>" size="30" maxlength="500" align="center"/>
          </font></font>&nbsp; &nbsp;&nbsp; </td>
  	  </tr>
    	<tr>
          <td>&nbsp;</td>        
          ...
          <font size="-1">N&atilde;o&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">Obs:
          <input name="desc_acidente_trajeto" type="text" id="desc_acidente_trajeto" value="<?php print utf8_encode($desc_acidente_trajeto) ?>" size="70" maxlength="500" align="center"/>
          </font></font></td>
  	  </tr>
   	  </table>      
    ...
    <table width="1152" height="304" border="1" frame="box" rules="none">
    	<tr>
        	...
        	<td height="83"><font size="-1">
              ...
              <font size="-1">N&atilde;o&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>&nbsp;&nbsp;Qual a velocidade do  ve&iacute;culo evidenciada no disco de tac&oacute;grafo no momento do ocorrido? <font size="-1">
       	      <input name="veloc_evidenc_disco" type="text" id="veloc_evidenc_disco" value="<?php print utf8_encode($veloc_evidenc_disco) ?>" size="50" maxlength="100" align="center"/>
       	      </font></p>
        	  <p>&nbsp;Coment&aacute;rios:&nbsp;&nbsp;<font size="-1">
   	      <input name="comentario_disco_tacografo" type="text" id="comentario_disco_tacografo" value="<?php print utf8_encode($comentario_disco_tacografo) ?>" size="70" maxlength="500" align="center"/>
   	      </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></td>
      </tr>
    	<tr>
    	  <td>&nbsp;</td>
    	...
    	<tr>
    	  ...
    	  <td height="59"><p><font size="-1">Utilizava cinto de seguran&ccedil;a:
            ...
            <input name="observacao" type="text" id="observacao" value="<?php print utf8_encode($observacao) ?>" size="50" maxlength="1000" align="center" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>Limite Velocidade da Pista: <font size="-1">
          <input name="limite_veloc_pista" type="text" id="limite_veloc_pista" value="<?php print $limite_veloc_pista ?>" size="1" maxlength="3" align="center" onkeypress='somente_numero(this)'/>
          </font></p></td>
  	  </tr>
    	<tr>
    	  <td>&nbsp;</td>
    	...
    	<tr>
          ...
          <input name="dados_bo" type="text" id="dados_bo" value="<?php print $dados_bo ?>" size="50" maxlength="500" align="center" />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data: 
          <input name="data_1" type="text" id="data_1" onblur="javascript:verifica_data_1(this)" onkeypress="valida_conteudo_data(this)" value="<?php print $data_bo ?>" size="7" maxlength="10" align="center"/>
          </font></td>
  	  </tr>
   	  </table>       
    ...
    <table width="1152" height="34" border="1" frame="box" rules="none">
    	<tr>
            ...
            ?>
   	      ...
   	      <p><font size="-1">
   	        <textarea name="desc_vel_pontas" id="desc_vel_pontas" cols="140" rows="3" value="" onkeyup='charLimit(this, 3000);'><?php print utf8_encode($desc_vel_pontas) ?></textarea>
   	      </font></p>
   	      <p>&nbsp;</p></td>
      </tr>
    	<tr>
    	...
    	<tr>
    	  ...
    	  <td><p><font size="-1"><b>Registrar a data do  &uacute;ltimo <strong><u>exame m&eacute;dico peri&oacute;dico</u></strong> realizado pelo motorista inclusive se houve registro de identifica&ccedil;&atilde;o de  anormalidades em algum dos exames realizados ou recomenda&ccedil;&atilde;o m&eacute;dica:</b></p>
           ...
           <input name="observ_exame_per" type="text" id="observ_exame_per" value="<?php print utf8_encode($observ_exame_per) ?>" size="165" maxlength="500" align="center" />
           </font></p>  
   	      <p>&nbsp;</p>
          <p>&nbsp;</p> 
         </td>
    ...
    <table width="1152" border="0">
    	...
    	<tr>
    	  <td width="528"><font size="-1">Nome:
   	      <input name="nome_testemunha" type="text" id="nome_testemunha" value="<?php print $nome_testemunha ?>" size="50" maxlength="100"/></td>
    	  <td width="614"><font size="-1">Fun&ccedil;&atilde;o:
              <input name="funcao_testemunha" type="text" id="funcao_testemunha" value="<?php print $funcao_testemunha ?>" size="50" maxlength="50"/>
    	  </font></td>
      </tr>
    	<tr>
    	  <td colspan="2">&nbsp;</td>
    	...
    	<tr>
    	  <td colspan="2"><font size="-1">Relato da testemunha:
    	      <textarea name="relato_testemunha" id="relato_testemunha" cols="145" rows="5" value="" onkeyup='charLimit(this, 3000);'><?php print utf8_encode($relato_testemunha) ?></textarea>
          </font></td>
  	  </tr>
   	  </table>    
    ...
    <table width="300" border="1">
      <tr>
        <td width="100" height="22"><div align="center">
          <?php
				if ($acidente_id == '')
					print "<a href=javascript:alert_anexos()><b><center>Anexos</b></center></a>";
				else
					print "<a href=javascript:pagina('upload.php?id=$acidente_id&tela=5','1200','600','Anexos')><b><center>Anexos</center></b></a>";
      		?>
        </div></td>
        <td width="200" height="22">
      		<a href=javascript:pagina('logs_alteracao.php?acidente_id=<?php print $acidente_id ?>&tela=5','1300','400','Logs')><b>
   ...
   <table width="619" border="0" align="center">        
        ...
        <tr>
          <td colspan="2" class="txt_home"><div align="center">
            ...
            <input name='imprimir' type='button' class='botao_site' value=" Imprimir "
			  id="imprimir"
			  onclick="javascript:pagina('imp_investigacao_analise.php?id=<?php print $acidente_id ?>&amp;si=<?php print $sistema_id ?>','1300','800','analise_causa')"/>

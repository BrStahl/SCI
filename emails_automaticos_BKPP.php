...
<br><br><br><b>SCI - Registro de Ocorrências</b>",
	...
	foreach ($emails as $email => $ids) {
		...
		$enviou = enviar_email(
			...
			"SCI - Registro de Ocorrências",
			$email,
			"Ocorrência: $acidente_id - Plano de Ação",
			"Email automático
		<br><br><br>Prezado(a).
		...
		if ($ferido_sts != '') {
			...
			while (odbc_fetch_row($result_ppae_sts)) {
				...
				$enviou_ppae_sts = enviar_email(
					...
					"Email automático
					<br><br><br>Prezado(a).
					<br><br><br>A ocorrência <b>" . $acidente_id . "</b> esta com a Análise do coordenador PAE - STS pendente. Acesse o registro para realizar a Análise.
					<br><br><br><b>SCI - Registro de Ocorrências</b>",
					null,
					null,
					true
			...
			while (odbc_fetch_row($result_ppae_mtz)) {
				...
				$enviou_ppae_mtz = enviar_email(
					...
					"Email automático
					<br><br><br>Prezado(a).
					<br><br><br>A ocorrência <b>" . $acidente_id . "</b> está com a Análise do coordenador PAE pendente. Acesse o registro para realizar a Análise.
					<br><br><br><b>SCI - Registro de Ocorrências</b>",
					null,
					null,
					true
